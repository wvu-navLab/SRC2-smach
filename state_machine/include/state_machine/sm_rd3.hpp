...
public:
  ...
  ros::ServiceClient clt_circ_base_station_;
  ...
  void CirculateBaseStation(double throttle, double radius, double time);
  void MoveAroundBaseStation(double desired_range, double time);
};
